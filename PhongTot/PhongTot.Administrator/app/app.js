...
(function () {
    angular.module('myApp', ['ui.router', 'kendo.directives', 'blockUI', 'ngCkeditor', 'ngTagsInput', 'frapontillo.bootstrap-switch', 'ngSanitize', 'checklist-model', 'angularFileUpload', 'ui.bootstrap'])
        .config(config)
    ...
    function config($stateProvider, $urlRouterProvider) {
        $stateProvider
            ...
            .state('membershipadd', {
                url: "/membershipadd",
                parent: 'base',
                templateUrl: "/app/components/membershipProfile/membershipProfileAddView.html",
                controller: "membershipProfileAddController",
            })
